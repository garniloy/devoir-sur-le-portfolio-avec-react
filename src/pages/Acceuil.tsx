        ...
        <main>
            ...
            <div className="section-info">
                <div className="a-propos">
                    <h2>A propos</h2>
                    <img src={jdimage} alt="john doe about" className="profil" />
                    <p>
                ...
                <div className="mes-competences">
                    ...
                    <ul className="competence-list list-unstyled">
                        ...
                        <li>REACT 65%
                            <div className="progress" role="progressbar" aria-label="Default example" aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}>
